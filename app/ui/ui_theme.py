...
class UiThemeMixin:
    ...
    def switch_theme(self, theme_name):
        ...
        # Update components
        self.tabbed_editor.switch_theme(theme_name, text_color, global_bg)
        
        # Update Title Edit Style explicitly
        if hasattr(self.tabbed_editor, "title_edit") and self.tabbed_editor.title_edit:
             title_style = ThemeManager.get_title_style(theme_name, global_bg, text_color)
             self.tabbed_editor.title_edit.setStyleSheet(title_style)
        
        # Apply Global Scrollbar, Splitter & Tab Style
        ...
        tab_style = ThemeManager.get_tab_style(theme_name, global_bg)
        QApplication.instance().setStyleSheet(scrollbar_style + toolbar_style + splitter_style + tab_style)
